    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70">
      ...
      <div className="bg-[#433d3a] p-10 rounded-xl shadow-2xl flex flex-col items-center gap-6 max-w-sm w-full">
        <div className="flex flex-col items-center gap-4">
          <svg className={`${isError ? "" : "animate-spin"} h-10 w-10 text-[#C3B299]`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
        ...
        <div className="flex items-center justify-center gap-3">
          {isError && (
            <button
              className="px-8 py-2 bg-[#C3B299] text-[#433d3a] font-bold rounded-lg hover:bg-[#d7c9b8] transition"
              onClick={onRetry}
            >
              Retry
            </button>
